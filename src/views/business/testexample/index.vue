...
<script>
import { listExample, getExample, delExample, addExample, updateExample } from "@/api/business/testexample/example";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除测试示例编号为"' + ids + '"的数据项？').then(function() {
