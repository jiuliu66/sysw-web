<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="消息接收人" prop="recipient">
        <el-input
      ...
      <el-form-item label="消息接收人的手机号码" prop="recipientPhone">
        <el-input
    ...
    <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="消息接收人" align="center" prop="recipient" />
      <el-table-column label="消息接收人的微信openid" align="center" prop="recipientOpenid" />
      <el-table-column label="消息接收人的手机号码" align="center" prop="recipientPhone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="消息接收人" prop="recipient">
          <el-input v-model="form.recipient" placeholder="请输入消息接收人" />
        </el-form-item>
        <el-form-item label="消息接收人的微信openid" prop="recipientOpenid">
          <el-input v-model="form.recipientOpenid" placeholder="请输入消息接收人的微信openid" />
        </el-form-item>
        <el-form-item label="消息接收人的手机号码" prop="recipientPhone">
          <el-input v-model="form.recipientPhone" placeholder="请输入消息接收人的手机号码" />
        </el-form-item>
